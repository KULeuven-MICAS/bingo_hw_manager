...
// This module implements the second type of mailbox.
`include "common_cells/registers.svh"
module bingo_hw_manager_read_mailbox #(
    ...
    // FIFO write ports
    input  data_t                  mbox_data_i,  // data input to FIFO
    input  logic                   mbox_push_i,  // push signal from FIFO
    output logic                   mbox_full_o,  // full signal from FIFO
    ...
    bingo_hw_manager_mailbox_adapter #(
        ...
        // write FIFO port
        .mbox_w_data_o  ( /*not used*/  ),
        .mbox_w_full_i  ( '0            ),
        .mbox_w_push_o  ( /*not used*/  ), // not used in this mailbox type
        .mbox_w_flush_o ( /*not used*/  ), // not used in this mailbox type
        .mbox_w_usage_i ( '0            ),
        // read FIFO port
    ...
    fifo_v3 #(
        ...
        .rst_ni      ( rst_ni      ),
        .testmode_i  ( test_i      ),
        .flush_i     ( mbox_flush_i | r_mbox_flush  ),
        .full_o      ( mbox_full   ),
        .empty_o     ( mbox_empty  ),
        .usage_o     ( mbox_usage  ),
        .data_i      ( mbox_w_data ),
    ...
    assign mbox_w_data  = mbox_data_i;
    assign mbox_push    = mbox_push_i;
    assign mbox_full_o  = mbox_full;
